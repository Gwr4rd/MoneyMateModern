...
`MoneyMateModern-GitHub-v1.4.0` y sigue la guia
...
3. Abre la carpeta `MoneyMateModern-GitHub-v1.4.0` en el Explorador de Windows.
...
2. Crea la etiqueta `v1.4.0`.
3. Usa como titulo `MoneyMate Modern 1.4.0`.
4. Pega el contenido de `RELEASE_NOTES.md`.
5. Adjunta `MoneyMateModern-release-signed-v1.4.0.apk`.
