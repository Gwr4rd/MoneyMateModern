...
No se necesita ningun archivo comprimido. Usa la carpeta del proyecto
`MoneyMateModern` y sigue la guia
...
3. Abre la carpeta `MoneyMateModern` en el Explorador de Windows.
...
2. Crea la etiqueta `v2.1.0`.
3. Usa como titulo `Control Financiero 2.1.0`.
4. Pega el contenido de `RELEASE_NOTES.md`.
5. Adjunta `Control-Financiero-release-signed-v2.1.0.apk`.
