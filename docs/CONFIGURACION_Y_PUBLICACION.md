...
`MoneyMateModern-GitHub-v1.4.1` y sigue la guia
...
3. Abre la carpeta `MoneyMateModern-GitHub-v1.4.1` en el Explorador de Windows.
...
2. Crea la etiqueta `v1.4.1`.
3. Usa como titulo `MoneyMate Modern 1.4.1`.
4. Pega el contenido de `RELEASE_NOTES.md`.
5. Adjunta `MoneyMateModern-release-signed-v1.4.1.apk`.
